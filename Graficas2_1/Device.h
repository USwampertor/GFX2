...
public:
	...
	void Render(ID3D11RenderTargetView* pRenderTargetView);
...
HRESULT Device::InitializeDevice(HWND g_hWnd)
{
	HRESULT hr = S_OK;
...
void Device::Render(ID3D11RenderTargetView* pRenderTargetView)
{
